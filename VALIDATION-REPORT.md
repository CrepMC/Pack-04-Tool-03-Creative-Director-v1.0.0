...
- JSON files parsed: 13
- JSON parse errors: 0
- Markdown files: 50
- Approx. markdown words: 10,181
- Approx. markdown characters: 74,313
...
- [x] CreativeBrief/candidate/boundary/handoff schemas exist.
- [x] Product mutation firewall documented.
- [x] Candidate diversity and scoring documented.
- [x] Camera/Motion/Environment/Cinematic ownership boundaries documented.
- [x] Acceptance/regression/adversarial/contract tests exist.
- [x] Unsupported claim guard documented.
- [x] Locked CreativeBrief revision policy documented.
